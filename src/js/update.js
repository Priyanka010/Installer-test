...
const updateOptions = {
    gitRepo: "Installer-test", // [Required] Your Repo Name
    gitUsername: "Priyanka010",  // [Required] Your GitHub Username.

    appName: "Installer-test", //[Required] The Name of the app archive and the app folder.
    appExecutableName: "Installer-test.exe", //[Required] The Executable of the Application to be Run after updating.
